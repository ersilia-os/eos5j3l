...
except ImportError:  # xtb-python is conda-only and unused on the ligand-conditioned path
    class _XTBUnavailable:
        def __getattr__(self, name):
            return None
    Param = _XTBUnavailable()
    Calculator = VERBOSITY_MUTED = None
